...
public class DbHelper extends SQLiteOpenHelper {
    ...
    private static final String DROP_STUDENT_TABLE = "DROP TABLE IF EXISTS "+CLASS_TABLE_NAME;
    private static final String SELECT_STUDENT_TABLE = "SELECT * FROM "+CLASS_TABLE_NAME;
    ...
    Cursor getClassNamesAndSubjects() {
        SQLiteDatabase database = this.getReadableDatabase();
        String[] columns = {CLASS_NAME_KEY, SUBJECT_NAME_KEY};
        return database.query(CLASS_TABLE_NAME, columns, null, null, null, null, null);
    }
    ...
    long addClass(String className, String subjectName) {
        ...
        long cid = database.insert(CLASS_TABLE_NAME, null, values);
        database.close();
        return cid;
    }
    ...
    Cursor getStudentTable(long cid){
        ...
        return database.query(STUDENT_TABLE_NAME, null, C_ID + "=?", selectionArgs, null, null, STUDENT_ROLL_KEY);
    }
